...
public class ObservableType {
    ...
    protected List<MeasureSourceType> observableSource;
    ...
    /**
     * Gets the value of the observableSource property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the observableSource property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getObservableSource().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<MeasureSourceType> getObservableSource() {
        if (observableSource == null) {
            observableSource = new ArrayList<MeasureSourceType>();
        }
