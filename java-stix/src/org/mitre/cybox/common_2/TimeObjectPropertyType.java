 ...
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://cybox.mitre.org/common-2>TimeObjectPropertyRestrictionType">
 *       &lt;attribute name="precision" type="{http://cybox.mitre.org/common-2}TimePrecisionEnum" default="second" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "TimeObjectPropertyType")
public class TimeObjectPropertyType
    extends TimeObjectPropertyRestrictionType
{

    @XmlAttribute(name = "precision")
    protected TimePrecisionEnum precision;
     ...
     *     
     */
    public TimePrecisionEnum getPrecision() {
        if (precision == null) {
            return TimePrecisionEnum.SECOND;
        } else {
            return precision;
        }
    }
     ...
     *     
     */
    public void setPrecision(TimePrecisionEnum value) {
