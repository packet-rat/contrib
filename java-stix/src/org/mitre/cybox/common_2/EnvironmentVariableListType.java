...
public class EnvironmentVariableListType {
    ...
    protected List<EnvironmentVariableType> environmentVariable;
     ...
     * 
     */
    public List<EnvironmentVariableType> getEnvironmentVariable() {
        if (environmentVariable == null) {
            environmentVariable = new ArrayList<EnvironmentVariableType>();
        }
