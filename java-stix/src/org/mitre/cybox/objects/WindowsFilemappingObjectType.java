...
@XmlType(name = "WindowsFilemappingObjectType", namespace = "http://cybox.mitre.org/objects#WinFilemappingObject-1", propOrder = {
    ...
    "handle",
    "pageProtectionValue",
    "pageProtectionAttribute",
    "maximumSize",
    "actualSize",
    "securityAttributes"
})
public class WindowsFilemappingObjectType
    extends ObjectPropertiesType
{
    ...
    protected WindowsHandleObjectType fileHandle;
    ...
    protected List<PageProtectionAttributeType> pageProtectionAttribute;
     ...
     *     
     */
    public WindowsHandleObjectType getFileHandle() {
        return fileHandle;
    }
     ...
     *     
     */
    public void setFileHandle(WindowsHandleObjectType value) {
    ...
    /**
     * Gets the value of the pageProtectionAttribute property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the pageProtectionAttribute property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPageProtectionAttribute().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PageProtectionAttributeType> getPageProtectionAttribute() {
        if (pageProtectionAttribute == null) {
            pageProtectionAttribute = new ArrayList<PageProtectionAttributeType>();
        }
        return this.pageProtectionAttribute;
    }
