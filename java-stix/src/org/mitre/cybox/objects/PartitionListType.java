...
public class PartitionListType {
    ...
    protected List<DiskPartitionObjectType> partition;
     ...
     * {@link DiskPartitionObjectType }
     * 
     * 
     */
    public List<DiskPartitionObjectType> getPartition() {
        if (partition == null) {
            partition = new ArrayList<DiskPartitionObjectType>();
        }
