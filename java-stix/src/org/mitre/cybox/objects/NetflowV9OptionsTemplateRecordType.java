...
@XmlType(name = "NetflowV9OptionsTemplateRecordType", namespace = "http://cybox.mitre.org/objects#NetworkFlowObject-2", propOrder = {
    ...
    "optionScopeLength",
    "optionLength",
    "scopeFieldTypeAndScopeFieldLength",
    "optionFieldTypeAndOptionFieldLength"
})
public class NetflowV9OptionsTemplateRecordType {
    ...
    protected List<BaseObjectPropertyType> scopeFieldTypeAndScopeFieldLength;
    @XmlElements({
    ...
    protected List<BaseObjectPropertyType> optionFieldTypeAndOptionFieldLength;
    ...
    /**
     * Gets the value of the scopeFieldTypeAndScopeFieldLength property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the scopeFieldTypeAndScopeFieldLength property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getScopeFieldTypeAndScopeFieldLength().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<BaseObjectPropertyType> getScopeFieldTypeAndScopeFieldLength() {
        if (scopeFieldTypeAndScopeFieldLength == null) {
            scopeFieldTypeAndScopeFieldLength = new ArrayList<BaseObjectPropertyType>();
        }
        return this.scopeFieldTypeAndScopeFieldLength;
    }

    /**
     * Gets the value of the optionFieldTypeAndOptionFieldLength property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the optionFieldTypeAndOptionFieldLength property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOptionFieldTypeAndOptionFieldLength().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<BaseObjectPropertyType> getOptionFieldTypeAndOptionFieldLength() {
        if (optionFieldTypeAndOptionFieldLength == null) {
            optionFieldTypeAndOptionFieldLength = new ArrayList<BaseObjectPropertyType>();
        }
        return this.optionFieldTypeAndOptionFieldLength;
    }
