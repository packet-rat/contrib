...
public class NetworkConnectionObjectType
    extends ObjectPropertiesType
{
    ...
    protected SocketAddressObjectType sourceSocketAddress;
    @XmlElement(name = "Source_TCP_State")
    protected TCPStateEnum sourceTCPState;
    @XmlElement(name = "Destination_Socket_Address")
    protected SocketAddressObjectType destinationSocketAddress;
     ...
     *     
     */
    public SocketAddressObjectType getSourceSocketAddress() {
     ...
     *     
     */
    public void setSourceSocketAddress(SocketAddressObjectType value) {
     ...
     *     
     */
    public SocketAddressObjectType getDestinationSocketAddress() {
     ...
     *     
     */
    public void setDestinationSocketAddress(SocketAddressObjectType value) {
