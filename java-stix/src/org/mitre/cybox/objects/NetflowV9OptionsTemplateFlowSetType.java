...
public class NetflowV9OptionsTemplateFlowSetType {
    ...
    protected List<NetflowV9OptionsTemplateRecordType> optionsTemplateRecord;
    ...
    /**
     * Gets the value of the optionsTemplateRecord property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the optionsTemplateRecord property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOptionsTemplateRecord().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<NetflowV9OptionsTemplateRecordType> getOptionsTemplateRecord() {
        if (optionsTemplateRecord == null) {
            optionsTemplateRecord = new ArrayList<NetflowV9OptionsTemplateRecordType>();
        }
        return this.optionsTemplateRecord;
    }
