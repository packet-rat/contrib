...
public class WindowsSystemObjectType
    extends SystemObjectType
{

    @XmlElement(name = "Domain")
    protected List<StringObjectPropertyType> domain;
     ...
     * 
     */
    public List<StringObjectPropertyType> getDomain() {
        if (domain == null) {
            domain = new ArrayList<StringObjectPropertyType>();
        }
        return this.domain;
    }
