...
public class IDTEntryListType {
    ...
    protected List<IDTEntryType> idtEntry;

    /**
     * Gets the value of the idtEntry property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the idtEntry property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getIDTEntry().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<IDTEntryType> getIDTEntry() {
        if (idtEntry == null) {
            idtEntry = new ArrayList<IDTEntryType>();
        }
        return this.idtEntry;
    }
