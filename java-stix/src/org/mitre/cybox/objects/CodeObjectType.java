    ...
    extends ObjectPropertiesType
{
    ...
    protected List<ProcessorTypeType> processorFamily;
     ...
     * This is why there is not a <CODE>set</CODE> method for the processorFamily property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getProcessorFamily().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ProcessorTypeType> getProcessorFamily() {
        if (processorFamily == null) {
            processorFamily = new ArrayList<ProcessorTypeType>();
        }
