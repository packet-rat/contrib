...
public class GlobalFlagListType {
    ...
    protected List<GlobalFlagType> globalFlag;
     ...
     * This is why there is not a <CODE>set</CODE> method for the globalFlag property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getGlobalFlag().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<GlobalFlagType> getGlobalFlag() {
        if (globalFlag == null) {
            globalFlag = new ArrayList<GlobalFlagType>();
        }
