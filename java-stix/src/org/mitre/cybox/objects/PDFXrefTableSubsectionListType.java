...
public class PDFXrefTableSubsectionListType {
    ...
    protected List<PDFXrefTableSubsectionType> subsection;
     ...
     * 
     */
    public List<PDFXrefTableSubsectionType> getSubsection() {
        if (subsection == null) {
            subsection = new ArrayList<PDFXrefTableSubsectionType>();
        }
