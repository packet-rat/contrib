...
public class DestinationOptionsType {
    ...
    protected List<OptionDataType> optionData;
     ...
     * This is why there is not a <CODE>set</CODE> method for the optionData property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOptionData().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<OptionDataType> getOptionData() {
        if (optionData == null) {
            optionData = new ArrayList<OptionDataType>();
        }
