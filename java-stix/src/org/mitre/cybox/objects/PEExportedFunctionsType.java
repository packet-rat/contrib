...
public class PEExportedFunctionsType {
    ...
    protected List<PEExportedFunctionType> exportedFunction;

    /**
     * Gets the value of the exportedFunction property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the exportedFunction property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getExportedFunction().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PEExportedFunctionType> getExportedFunction() {
        if (exportedFunction == null) {
            exportedFunction = new ArrayList<PEExportedFunctionType>();
        }
