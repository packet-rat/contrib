...
@XmlType(name = "IPFIXSetType", namespace = "http://cybox.mitre.org/objects#NetworkFlowObject-2", propOrder = {
    "templateSetOrOptionsTemplateSetOrDataSet"
})
public class IPFIXSetType {
    ...
    protected List<Object> templateSetOrOptionsTemplateSetOrDataSet;

    /**
     * Gets the value of the templateSetOrOptionsTemplateSetOrDataSet property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the templateSetOrOptionsTemplateSetOrDataSet property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTemplateSetOrOptionsTemplateSetOrDataSet().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getTemplateSetOrOptionsTemplateSetOrDataSet() {
        if (templateSetOrOptionsTemplateSetOrDataSet == null) {
            templateSetOrOptionsTemplateSetOrDataSet = new ArrayList<Object>();
        }
        return this.templateSetOrOptionsTemplateSetOrDataSet;
    }
