...
/**
 * <p>Java class for ObjectRelationshipEnum-1.0.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="ObjectRelationshipEnum-1.0">
...
public enum ObjectRelationshipEnum10 {
    ...
    ObjectRelationshipEnum10(String v) {
        value = v;
    }
    ...
    public static ObjectRelationshipEnum10 fromValue(String v) {
        for (ObjectRelationshipEnum10 c: ObjectRelationshipEnum10 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
