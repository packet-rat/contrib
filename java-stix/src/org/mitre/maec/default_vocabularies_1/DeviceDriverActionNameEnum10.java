...
/**
 * <p>Java class for DeviceDriverActionNameEnum-1.0.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="DeviceDriverActionNameEnum-1.0">
 ...
 * 
 */
@XmlType(name = "DeviceDriverActionNameEnum-1.0")
@XmlEnum
public enum DeviceDriverActionNameEnum10 {
    ...
    DeviceDriverActionNameEnum10(String v) {
        value = v;
    }
    ...
    public static DeviceDriverActionNameEnum10 fromValue(String v) {
        for (DeviceDriverActionNameEnum10 c: DeviceDriverActionNameEnum10 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
