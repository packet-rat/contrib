...
/**
 * <p>Java class for FileActionNameEnum-1.0.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="FileActionNameEnum-1.0">
 ...
 * 
 */
@XmlType(name = "FileActionNameEnum-1.0")
@XmlEnum
public enum FileActionNameEnum10 {
    ...
    public static FileActionNameEnum10 fromValue(String v) {
        for (FileActionNameEnum10 c: FileActionNameEnum10 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
