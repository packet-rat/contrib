...
/**
 * <p>Java class for NetworkActionNameEnum-1.0.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="NetworkActionNameEnum-1.0">
 ...
 * 
 */
@XmlType(name = "NetworkActionNameEnum-1.0")
@XmlEnum
public enum NetworkActionNameEnum10 {
    ...
    NetworkActionNameEnum10(String v) {
        value = v;
    }
    ...
    public static NetworkActionNameEnum10 fromValue(String v) {
        for (NetworkActionNameEnum10 c: NetworkActionNameEnum10 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
