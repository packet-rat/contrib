    ...
    extends GenericRelationshipListType
{
    ...
    protected List<RelatedThreatActorType> attributedThreatActor;

    /**
     * Gets the value of the attributedThreatActor property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the attributedThreatActor property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAttributedThreatActor().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<RelatedThreatActorType> getAttributedThreatActor() {
        if (attributedThreatActor == null) {
            attributedThreatActor = new ArrayList<RelatedThreatActorType>();
        }
        return this.attributedThreatActor;
    }
