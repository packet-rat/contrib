    ...
    extends IncidentBaseType
{
    ...
    protected List<InformationSourceType> responder;
    @XmlElement(name = "Coordinator")
    protected List<InformationSourceType> coordinator;
    @XmlElement(name = "Victim")
    protected List<IdentityType> victim;
    ...
    protected List<ControlledVocabularyStringType> discoveryMethod;
    @XmlElement(name = "Related_Incidents")
    protected RelatedIncidentsType relatedIncidents;
    @XmlElement(name = "COA_Requested")
    protected List<COARequestedType> coaRequested;
    @XmlElement(name = "COA_Taken")
    protected List<COATakenType> coaTaken;
    @XmlElement(name = "Confidence")
    protected ConfidenceType confidence;
    @XmlElement(name = "Contact")
    protected List<InformationSourceType> contact;
     ...
     * 
     */
    public List<InformationSourceType> getResponder() {
        if (responder == null) {
            responder = new ArrayList<InformationSourceType>();
        }
     ...
     * 
     */
    public List<InformationSourceType> getCoordinator() {
        if (coordinator == null) {
            coordinator = new ArrayList<InformationSourceType>();
        }
     ...
     * 
     */
    public List<IdentityType> getVictim() {
        if (victim == null) {
            victim = new ArrayList<IdentityType>();
        }
        return this.victim;
    }
     ...
     * 
     */
    public List<ControlledVocabularyStringType> getDiscoveryMethod() {
        if (discoveryMethod == null) {
            discoveryMethod = new ArrayList<ControlledVocabularyStringType>();
        }
    ...
    /**
     * Gets the value of the coaRequested property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the coaRequested property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCOARequested().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<COARequestedType> getCOARequested() {
        if (coaRequested == null) {
            coaRequested = new ArrayList<COARequestedType>();
        }
        return this.coaRequested;
    }

    /**
     * Gets the value of the coaTaken property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the coaTaken property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCOATaken().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<COATakenType> getCOATaken() {
        if (coaTaken == null) {
            coaTaken = new ArrayList<COATakenType>();
        }
        return this.coaTaken;
    }
     ...
     * 
     */
    public List<InformationSourceType> getContact() {
        if (contact == null) {
            contact = new ArrayList<InformationSourceType>();
        }
        return this.contact;
    }
