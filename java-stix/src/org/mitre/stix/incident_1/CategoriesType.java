...
public class CategoriesType {
    ...
    protected List<ControlledVocabularyStringType> category;
     ...
     * 
     */
    public List<ControlledVocabularyStringType> getCategory() {
        if (category == null) {
            category = new ArrayList<ControlledVocabularyStringType>();
        }
