    ...
    extends GenericRelationshipListType
{
    ...
    protected List<RelatedCampaignType> associatedCampaign;

    /**
     * Gets the value of the associatedCampaign property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the associatedCampaign property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAssociatedCampaign().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<RelatedCampaignType> getAssociatedCampaign() {
        if (associatedCampaign == null) {
            associatedCampaign = new ArrayList<RelatedCampaignType>();
        }
