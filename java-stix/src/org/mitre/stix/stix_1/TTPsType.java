...
public class TTPsType {
    ...
    @XmlElement(name = "TTP")
    protected List<TTPBaseType> ttp;
     ...
     * This is why there is not a <CODE>set</CODE> method for the ttp property.
     * 
     * <p>
     ...
     * 
     */
    public List<TTPBaseType> getTTP() {
        if (ttp == null) {
            ttp = new ArrayList<TTPBaseType>();
        }
        return this.ttp;
    }
