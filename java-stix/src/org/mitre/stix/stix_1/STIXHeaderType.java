...
public class STIXHeaderType {
    ...
    protected List<ControlledVocabularyStringType> packageIntent;
    ...
    /**
     * Gets the value of the packageIntent property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the packageIntent property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPackageIntent().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ControlledVocabularyStringType> getPackageIntent() {
        if (packageIntent == null) {
            packageIntent = new ArrayList<ControlledVocabularyStringType>();
        }
