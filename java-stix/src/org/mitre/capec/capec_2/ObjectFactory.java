...
public class ObjectFactory {
    ...
    private final static QName _StructuredTextTypeImages_QNAME = new QName("http://capec.mitre.org/capec-2", "Images");
    private final static QName _StructuredTextTypeComment_QNAME = new QName("http://capec.mitre.org/capec-2", "Comment");
    private final static QName _StructuredTextTypeCodeExampleLanguage_QNAME = new QName("http://capec.mitre.org/capec-2", "Code_Example_Language");
    private final static QName _StructuredTextTypeCode_QNAME = new QName("http://capec.mitre.org/capec-2", "Code");
    private final static QName _StructuredTextTypeText_QNAME = new QName("http://capec.mitre.org/capec-2", "Text");
    private final static QName _StructuredTextTypeTextTitle_QNAME = new QName("http://capec.mitre.org/capec-2", "Text_Title");
